...
function setup() {
	...
	mangoObject1 = new Mango(600,180,30);
	mangoObject2 = new Mango(680,280,30);
	mangoObject3 = new Mango(600,250,30);
	mangoObject4 = new Mango(520,300,30);
	mangoObject5 = new Mango(550,200,30);
